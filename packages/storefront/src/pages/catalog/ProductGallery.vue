...
<template>
  <div class="gallery">
    ...
    <div class="gallery__docs">
      <div class="gallery__docs-title">Документы</div>
      <a class="gallery__doc-link" href="#">Сертификат соответствия <span>PDF</span></a>
      <a class="gallery__doc-link" href="#">Паспорт качества <span>PDF</span></a>
    </div>
  </div>
</template>
