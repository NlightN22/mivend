...
async function createProduct(token, { name, slug, description, facetValueIds, optionGroup, variants }) {
    // 1. Create product
    ...
    if (optionGroup) {
        ...
        `, { productId, optionGroupId: groupData.createProductOptionGroup.id }, token);
    }
...
async function main() {
    ...
    await createProduct(token, {
        ...
        optionGroup: {
            name: 'Volume', code: 'volume-luk-5w40',
            options: [{ name: '1L', code: '1l' }, { name: '4L', code: '4l' }, { name: '5L', code: '5l' }],
        },
        variants: [
    ...
    await createProduct(token, {
        ...
        optionGroup: {
            name: 'Volume', code: 'volume-mot-5w30',
            options: [{ name: '1L', code: '1l' }, { name: '4L', code: '4l' }],
        },
        variants: [
    ...
    await createProduct(token, {
        ...
        variants: [
            { name: 'Unit', sku: 'NGK-BPR6ES', price: 15000, stock: 1000 },
        ],
    });
    ...
    await createProduct(token, {
        ...
        optionGroup: {
            name: 'Volume', code: 'volume-sin-g12',
            options: [{ name: '1L', code: '1l' }, { name: '5L', code: '5l' }, { name: '10L', code: '10l' }],
        },
        variants: [
    ...
    await createProduct(token, {
        ...
        variants: [
            { name: 'Standard', sku: 'BSC-S4-60', price: 890000, stock: 50 },
        ],
    });
